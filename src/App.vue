  ...
  <div id="app">
    ...
    <div class="main-wrapper">
      <div id="about">
        ...
        <div class="bio">
          <p>
            My name is Alexx Martínez and I am a Web Developer from El Salvador,
            Central America.
          </p>
          ...
          <p>
            Currently I have a full-time web developer job at
            <a
...
#about > h2, #stack > h2, #projects > h2, #contactMe > h2 {
    text-align: center;
    color: #232323;
